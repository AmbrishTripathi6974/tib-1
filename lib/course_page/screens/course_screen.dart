                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing:
                            8, // Adjust the spacing between items as per your preference
                        runSpacing:
                            10, // Adjust the vertical spacing between lines as per your preference
                        children: [
                          for (int index = 0;
                              index < model.chips.length - 1;
                              index++)
                            Row(
                              children: [
                                ActionChip(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image:
                                AssetImage('assets/images/tib_certificate.png'),
                          ),
                        ),
                      ),
                    ],
